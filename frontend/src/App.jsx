        ...
        <div style={{ display: 'grid', gridTemplateColumns: '272px 1fr 280px', overflow: 'hidden', minHeight: 0 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', overflow: 'hidden', minHeight: 0 }}>
            ...
            <div style={{ flex: 1, position: 'relative', overflow: 'hidden' }}>
              <GraphPanel graph={state.graph} isThinking={isThinking} />
              {isThinking && (
                <div style={{
          ...
          <div style={{ position: 'fixed', inset: 0, background: 'rgba(7,9,15,.96)', zIndex: 50, display: 'flex', flexDirection: 'column', padding: 24, overflow: 'hidden' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
              ...
              <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
                ...
                <button onClick={() => setShowBrief(false)} style={{ background: '#131929', border: '1px solid #1e2a3a', borderRadius: 4, padding: '5px 12px', color: '#e2e8f0', fontFamily: 'Space Mono', fontSize: 11, cursor: 'pointer' }}>Close</button>
              </div>
            </div>
